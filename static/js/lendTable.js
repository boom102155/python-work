$(document).ready(function() {
	...
	$('#example tbody').on('click', 'tr', 'td', function () {
	    ...
	    $("#txtEID").val($(this).closest('tr').children()[5].textContent);
	    $("#txtSerial").val($(this).closest('tr').children()[6].textContent);
	    $("#txtEquipment").val($(this).closest('tr').children()[7].textContent);
    } );
} );